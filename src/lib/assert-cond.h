...
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_NAME	"Plugin provider"
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_ID	"plugin-provider"

#define BT_ASSERT_PRE_PLUGIN_PROVIDER_NON_NULL(_plugin_provider) \
	BT_ASSERT_PRE_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_ID, (_plugin_provider), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_NAME)

#define BT_ASSERT_PRE_DEV_PLUGIN_PROVIDER_NON_NULL(_plugin_provider) \
	BT_ASSERT_PRE_DEV_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_ID, (_plugin_provider), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_NAME)

#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_NAME	"Plugin provider info"
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_ID		"plugin-provider-info"

#define BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_NON_NULL(_plugin_provider_info) \
	BT_ASSERT_PRE_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_ID, (_plugin_provider_info), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_NAME)

#define BT_ASSERT_PRE_DEV_PLUGIN_PROVIDER_INFO_NON_NULL(_plugin_provider_info) \
	BT_ASSERT_PRE_DEV_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_ID, (_plugin_provider_info), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_INFO_NAME)

#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_NAME	"Plugin provider options"
#define _BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_ID	"plugin-provider-options"

#define BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_NON_NULL(_plugin_provider_options) \
	BT_ASSERT_PRE_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_ID, (_plugin_provider_options), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_NAME)

#define BT_ASSERT_PRE_DEV_PLUGIN_PROVIDER_OPTIONS_NON_NULL(_plugin_provider_options) \
	BT_ASSERT_PRE_DEV_NON_NULL(_BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_ID, (_plugin_provider_options), \
		_BT_ASSERT_PRE_PLUGIN_PROVIDER_OPTIONS_NAME)
