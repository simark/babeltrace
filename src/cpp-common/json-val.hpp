...
#ifndef BABELTRACE_CPP_COMMON_JSON_VAL_HPP
#define BABELTRACE_CPP_COMMON_JSON_VAL_HPP
...
public:
    ...
    {
        BT_ASSERT_DBG(this->hasValue(key));
        return static_cast<const JsonValT&>(*(*this)[key]);
    }
...
#endif /* BABELTRACE_CPP_COMMON_JSON_VAL_HPP */
