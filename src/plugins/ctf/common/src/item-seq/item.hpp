...
public:
     ...
     */
    const nonstd::optional<unsigned long long>& id() const noexcept
    {
        return _mId;
    }
...
private:
    ...
    nonstd::optional<unsigned long long> _mId;
};
...
public:
     ...
     */
    const nonstd::optional<unsigned long long>& seqNum() const noexcept
    {
        return _mSeqNum;
    }
     ...
     * sequence).
     */
    const nonstd::optional<unsigned long long>& discEventRecordCounterSnap() const noexcept
    {
     ...
     * the packet, if any.
    */
    const nonstd::optional<bt2_common::DataLen>& expectedTotalLen() const noexcept
    {
     ...
     */
    const nonstd::optional<bt2_common::DataLen>& expectedContentLen() const noexcept
    {
     ...
     */
    const nonstd::optional<unsigned long long>& beginDefClkVal() const noexcept
    {
     ...
     */
    const nonstd::optional<unsigned long long>& endDefClkVal() const noexcept
    {
...
private:
    void _reset() noexcept
    {
        _mSeqNum = nonstd::nullopt;
        _mDiscErCounterSnap = nonstd::nullopt;
        _mExpectedTotalLen = nonstd::nullopt;
        _mExpectedContentLen = nonstd::nullopt;
        _mBeginDefClkVal = nonstd::nullopt;
        _mEndDefClkVal = nonstd::nullopt;
    }

    nonstd::optional<unsigned long long> _mSeqNum;
    nonstd::optional<unsigned long long> _mDiscErCounterSnap;
    nonstd::optional<bt2_common::DataLen> _mExpectedTotalLen;
    nonstd::optional<bt2_common::DataLen> _mExpectedContentLen;
    nonstd::optional<unsigned long long> _mBeginDefClkVal;
    nonstd::optional<unsigned long long> _mEndDefClkVal;
};
...
public:
     ...
     */
    const nonstd::optional<unsigned long long>& defClkVal() const noexcept
    {
        return _mDefClkVal;
    }
...
private:
    ...
    {
        _mCls = nullptr;
        _mDefClkVal = nonstd::nullopt;
    }

    const EventRecordCls *_mCls = nullptr;
    nonstd::optional<unsigned long long> _mDefClkVal;
};
...
public:
     ...
     */
    bt2_common::DataLen fieldLen() const noexcept
    {
        return bt2_common::DataLen::fromBits(*_mLen + *_mLen / 7);
    }
 ...
 * stream. Knowing this:
 *
 * • Use strEnd() to get the end of the null-terminated substring (the
 *   first null byte or end() if none).
 *
 * • Use strSize() to get the size of the null-terminated substring.
 *
...
public:
     ...
     *
     * Use strEnd() to get the end of the null-terminated substring.
     */
    ...
    /*
     * End of this null-terminated substring (points to either the first
     * null byte, or is end() if none).
     */
    ...
    /*
     * Size of this substring, including null characters and characters
     * after that, if any.
     *
     * Use strSize() to get the size of this null-terminated string,
     * excluding any terminating null character.
     */
    bt2_common::DataLen size() const noexcept
    {
        return bt2_common::DataLen::fromBytes(_mEnd - _mBegin);
    }

    /*
     * Size of this null-terminated substring, excluding any terminating
     * null character.
     */
    bt2_common::DataLen strSize() const noexcept
    {
        return bt2_common::DataLen::fromBytes(this->strEnd() - _mBegin);
    }
     ...
     * of this substring.
     */
    bpstd::string_view strView() const
    {
        return {_mBegin, static_cast<bpstd::string_view::size_type>(this->strSize().bytes())};
    }
...
protected:
    explicit NonNullTerminatedStrFieldBeginItem(Type type) noexcept;
...
protected:
    explicit NonNullTerminatedStrFieldEndItem(Type type) noexcept;
...
protected:
    explicit BlobFieldBeginItem(Type type) noexcept;
...
protected:
    explicit BlobFieldEndItem(Type type) noexcept;
