...
VarLenIntFieldItem::VarLenIntFieldItem(const Type type) noexcept :
    Item {type}, _mLen {bt2_common::DataLen::fromBits(0)}
{
}
...
NonNullTerminatedStrFieldBeginItem::NonNullTerminatedStrFieldBeginItem(const Type type) noexcept :
    BeginItem {type}, _mLen {bt2_common::DataLen::fromBits(0)}
{
}

NonNullTerminatedStrFieldEndItem::NonNullTerminatedStrFieldEndItem(const Type type) noexcept :
    EndItem {type}
{
}
...
BlobFieldBeginItem::BlobFieldBeginItem(const Type type) noexcept :
    BeginItem {type}, _mLen {bt2_common::DataLen::fromBits(0)}
{
}

BlobFieldEndItem::BlobFieldEndItem(const Type type) noexcept : EndItem {type}
{
}
