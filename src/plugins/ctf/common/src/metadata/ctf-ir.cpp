...
static inline bool isStdBitArrayFc(const unsigned int align, const bt2c::DataLen len) noexcept
{
                                                             ...
                                                             ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<FixedLenBitArrayFc>(internal::CtfIrMixins::Fc {deepType},
                                                     ...
                                                     ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<FixedLenBoolFc>(
                                                       ...
                                                       ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<FixedLenFloatFc>(internal::CtfIrMixins::Fc {deepType},
                                              internal::CtfIrMixins::FixedLenBitArrayFc {}, align,
                                              len, byteOrder, std::move(userAttrs));
}

std::unique_ptr<FixedLenUIntFc>
createFixedLenUIntFc(const unsigned int align, const bt2c::DataLen len,
                                                     ...
                                                     ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<FixedLenSIntFc>(internal::CtfIrMixins::Fc {deepType},
                                             internal::CtfIrMixins::FixedLenBitArrayFc {},
                                             internal::CtfIrMixins::FixedLenIntFc {}, align, len,
                                             byteOrder, prefDispBase, std::move(userAttrs));
}

std::unique_ptr<FixedLenUEnumFc>
createFixedLenUEnumFc(const unsigned int align, const bt2c::DataLen len,
...
createFixedLenSEnumFc(const unsigned int align, const bt2c::DataLen len,
                      ...
                      const ir::DispBase prefDispBase, ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<FixedLenSEnumFc>(
        internal::CtfIrMixins::Fc {deepType}, internal::CtfIrMixins::FixedLenBitArrayFc {},
                                                 ...
                                                 ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<VarLenUIntFc>(internal::CtfIrMixins::Fc {deepType},
...
std::unique_ptr<VarLenSIntFc> createVarLenSIntFc(const ir::DispBase prefDispBase,
                                                 ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<VarLenSIntFc>(internal::CtfIrMixins::Fc {FcDeepType::VAR_LEN_SINT},
                                                   ...
                                                   ir::OptUserAttrs userAttrs)
{
    ...
    return bt2s::make_unique<VarLenUEnumFc>(
...
std::unique_ptr<VarLenSEnumFc> createVarLenSEnumFc(FixedLenSEnumFc::Mappings mappings,
                                                   ...
                                                   ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<VarLenSEnumFc>(internal::CtfIrMixins::Fc {FcDeepType::VAR_LEN_SENUM},
                                            internal::CtfIrMixins::VarLenIntFc {},
                                            std::move(mappings), prefDispBase,
                                            std::move(userAttrs));
}

std::unique_ptr<NullTerminatedStrFc> createNullTerminatedStrFc(ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<NullTerminatedStrFc>(
                                                         ...
                                                         const bool hasMetadataStreamUuidRole)
{
    ...
    return bt2s::make_unique<StaticLenArrayFc>(internal::CtfIrMixins::Fc {deepType},
...
std::unique_ptr<DynLenArrayFc> createDynLenArrayFc(FieldLoc lenFieldLoc, Fc::UP elemFc,
                                                   ...
                                                   ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<DynLenArrayFc>(internal::CtfIrMixins::Fc {FcDeepType::DYN_LEN_ARRAY},
...
std::unique_ptr<StaticLenStrFc> createStaticLenStrFc(const std::size_t len,
                                                     ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<StaticLenStrFc>(internal::CtfIrMixins::Fc {FcDeepType::STATIC_LEN_STR},
                                             internal::CtfIrMixins::StaticLenStrFc {}, len,
                                             std::move(userAttrs));
}

std::unique_ptr<DynLenStrFc> createDynLenStrFc(FieldLoc lenFieldLoc, ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<DynLenStrFc>(internal::CtfIrMixins::Fc {FcDeepType::DYN_LEN_STR},
...
std::unique_ptr<DynLenBlobFc> createDynLenBlobFc(FieldLoc lenFieldLoc, std::string mediaType,
                                                 ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<DynLenBlobFc>(internal::CtfIrMixins::Fc {FcDeepType::DYN_LEN_BLOB},
...
{
    return bt2s::make_unique<StructFc>(internal::CtfIrMixins::Fc {FcDeepType::STRUCT},
...
ClkCls::SP createClkCls(std::string name, const unsigned long long freq,
                        ...
                        bt2s::optional<std::string> descr, const unsigned long long precision,
                        bt2s::optional<bt2c::Uuid> uuid, ir::OptUserAttrs userAttrs)
{
...
std::unique_ptr<EventRecordCls> createEventRecordCls(const unsigned long long id,
                                                     ...
                                                     ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<EventRecordCls>(internal::CtfIrMixins::EventRecordCls {}, id,
                                             std::move(ns), std::move(name), std::move(specCtxFc),
                                             std::move(payloadFc), std::move(userAttrs));
}

std::unique_ptr<DataStreamCls>
createDataStreamCls(const unsigned long long id, bt2s::optional<std::string> ns,
                    bt2s::optional<std::string> name, Fc::UP pktCtxFc, Fc::UP eventRecordHeaderFc,
...
std::unique_ptr<TraceCls> createTraceCls(bt2s::optional<bt2c::Uuid> uuid,
                                         bt2::ConstMapValue::Shared env, Fc::UP pktHeaderFc,
                                         ir::OptUserAttrs userAttrs)
{
    return bt2s::make_unique<TraceCls>(internal::CtfIrMixins::TraceCls {}, std::move(uuid),
