...
class GraphTestCase(unittest.TestCase):
    ...
    def test_add_component_user_cls(self):
        ...
        comp = self._graph.add_sink_component(MySink, 'salut')
    ...
    def test_add_component_gen_cls(self):
        ...
        comp = self._graph.add_sink_component(MySink, 'salut')
        assert comp
        comp2 = self._graph.add_sink_component(comp.component_class, 'salut2')
    ...
    def test_add_component_params(self):
        ...
        comp = self._graph.add_sink_component(MySink, 'salut', params)
