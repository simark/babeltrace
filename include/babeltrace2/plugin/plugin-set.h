...
Create a plugin set with bt_plugin_set_create().
...
/*!
@brief
    Creates and returns an empty set of plugins.

@returns
    New plugin set, or \c NULL on memory error.
*/
extern bt_plugin_set *bt_plugin_set_create(void) __BT_NOEXCEPT;
...
/*!
@brief
    Borrows the plugin named \bt_p{name} from the plugin set
    \bt_p{plugin_set}.
...
/*!
@brief
    Adds the plugin \bt_p{plugin} to the plugin set
    \bt_p{plugin_set}.
